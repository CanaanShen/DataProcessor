...
class IJCAIExtractor:
    ...
    def extractIJCAI(self, textDir, abstractDir, year, prefix):
    ...
    def extractIJCAI_Text(self, textDir, abstractDir, year, prefix):
...
ijcaiExtractor.extractIJCAI_Text(textDir, abstractDir, year, prefix)
print("Program ends")